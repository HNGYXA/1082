...
/* Definitions for Task_Other */
osThreadId_t Task_OtherHandle;
const osThreadAttr_t Task_Other_attributes = {
  .name = "Task_Other",
  .stack_size = 128 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of Task_Other */
  Task_OtherHandle = osThreadNew(Other, NULL, &Task_Other_attributes);
...
/* USER CODE BEGIN Header_Other */
/**
* @brief Function implementing the Task_Other thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Other */
void Other(void *argument)
{
  /* USER CODE BEGIN Other */
  /* Infinite loop */
  for(;;)
  {
		Other_Function();
